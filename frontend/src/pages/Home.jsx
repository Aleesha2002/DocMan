...
const Home = () => {
  return (
    <div>
      {/*======hero section========*/}
      <div className="hero__section pt-16  lg:pt-[60px] 2xl:h-[800px]  ">
        <div className="container mx-auto flex flex-col lg:flex-row lg:justify-between items-center lg:gap-16 ">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between  ">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <button className="btn1">Request an appointment</button>
              </div>
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  ...
                  online scheduling to select an appiontment time.
                </li>
              </ul>
              <Link to="/">
