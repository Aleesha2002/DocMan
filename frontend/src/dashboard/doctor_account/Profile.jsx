...
const Profile = ({ doctorData }) => {
  const [formData, setFormData] = useState({
    ...
    // ],
    experiences: [],
    //   { startingDate: "", endingDate: "", position: "", degree: "" },
    // ],
    timeSlots: [],
  ...
  //reusable input change functions
      ...
      <form action="" onSubmit={updateProfileHandler} >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  <div>
                    ...
                    <select
                      name="day"
                      value={item.day}
                      className="form__label py-3 px-5"
        ...
        <div>
          <button
            ...
            className="bg-primaryColor text-white text-[20px] font-bold leading-[30px] w-full py-3 px-6 rounded-lg "
          >
            Update Profile
          </button>
        </div>
